...
# Fichier: fix-tailwind-postcss-rapide.sh
# Description: Script de correction rapide pour le problème Tailwind/PostCSS

# --- Configuration ---
APP_DIR="/var/www/stock-management"
PM2_APP_NAME="stock-management"
LOG_FILE="$APP_DIR/fix_tailwind_postcss_rapide.log"
...
# --- Début du script ---
log_message "--- Démarrage de la correction rapide Tailwind/PostCSS ---"
...
# 10. Test de Prisma Client
log_message "10. Test de Prisma Client..."
node -e "
...
# 12. Redémarrage de l'application avec PM2
log_message "12. Redémarrage de l'application avec PM2..."
...
log_message "--- Correction rapide Tailwind/PostCSS terminée ---"
log_message "L'application devrait maintenant fonctionner SANS erreur Tailwind/PostCSS"
