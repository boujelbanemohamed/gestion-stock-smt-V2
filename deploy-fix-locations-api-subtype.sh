...
info "🔧 Déploiement de la correction API locations (subType et subSubType)"
info "==================================================================="
...
if grep -q "subSubType: true" app/api/locations/route.ts; then
  success "✅ Correction détectée (subType et subSubType dans l'API)"
else
...
info ""
info "La correction de l'API est maintenant active :"
info "  ✅ L'API /api/locations retourne maintenant subType et subSubType"
info "  ✅ Les cartes affichent correctement Type - Sous-type - Sous-sous-type"
info "  ✅ Visible dans l'onglet Emplacements"
info ""
info "Pour vérifier les logs : pm2 logs stock-app"
info ""
info "Note: Les erreurs 403 dans la console sont normales (préchargement Next.js)"
