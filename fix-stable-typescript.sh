...
# Fichier: fix-stable-typescript.sh
# Description: Script pour corriger les erreurs TypeScript dans la version stable

# --- Configuration ---
APP_DIR="/var/www/stock-management"
PM2_APP_NAME="stock-management-app"
LOG_FILE="$APP_DIR/fix_stable_typescript.log"
...
# --- Début du script ---
log_message "--- Démarrage de la correction TypeScript dans la version stable ---"
...
# 12. Corriger l'erreur TypeScript dans banks/import/route.ts
log_message "12. Correction de l'erreur TypeScript dans banks/import/route.ts..."
...
# 13. Corriger l'erreur TypeScript dans cards/import/route.ts
log_message "13. Correction de l'erreur TypeScript dans cards/import/route.ts..."
...
# 14. Corriger l'erreur TypeScript dans locations/import/route.ts
log_message "14. Correction de l'erreur TypeScript dans locations/import/route.ts..."
...
# 16. Vérifier que le dossier .next existe
log_message "16. Vérification du dossier .next..."
if [ -d ".next" ]; then
...
# 17. Redémarrer l'application
log_message "17. Redémarrage de l'application..."
pm2 start npm --name "$PM2_APP_NAME" -- run start
log_message "✓ Application redémarrée"

# 18. Attendre le démarrage
log_message "18. Attente du démarrage (30 secondes)..."
sleep 30

# 19. Vérifier le statut
log_message "19. Vérification du statut..."
pm2 status

# 20. Vérifier les logs
log_message "20. Vérification des logs (dernières 20 lignes)..."
pm2 logs "$PM2_APP_NAME" --lines 20

# 21. Tester l'API stats
log_message "21. Test de l'API stats..."
STATS_RESPONSE=$(curl -s "$APP_URL/api/stats")
log_message "Réponse API Stats: $STATS_RESPONSE"

# 22. Tester l'application complète
log_message "22. Test de l'application complète..."
...
# 23. Créer un script de test final
log_message "23. Création d'un script de test final..."
cat << 'EOF' > test-stable-typescript-fix.sh
#!/bin/bash
echo "Test de la version stable avec correction TypeScript..."
...
chmod +x test-stable-typescript-fix.sh
log_message "✓ Script test-stable-typescript-fix.sh créé"

log_message "--- Correction TypeScript dans la version stable terminée ---"
log_message "Utilisez './test-stable-typescript-fix.sh' pour tester l'application"
log_message "L'application devrait maintenant fonctionner avec la version stable (sans erreurs TypeScript)"
