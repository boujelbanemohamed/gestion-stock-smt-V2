...
info "🔧 Déploiement de l'affichage type/sous-type dans les emplacements"
info "=================================================================="
...
if grep -q "ci.card?.type || '-'" components/dashboard/locations-management.tsx; then
  success "✅ Correction détectée (type et sous-type dans l'affichage)"
else
...
info "  ✅ Type et sous-type affichés sous le nom de la carte"
info "  ✅ Format: 'Type - Sous-type'"
